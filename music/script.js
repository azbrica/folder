...
let songs = [
  ...
  lyrics: [
    { time: 0, text: "Nal seuchineun geudaeui yeoteun geu moksori" },
    { time: 0, text: "Nae ireumeul han beonman deo bulleojuseyo" },
    { time: 2000, text: "Eoreobeorin noeul arae meomchwo seoitjiman" },
    { time: 6200, text: "Geudae hyanghae han georeumssik georeogallaeyo" },
    { time: 8200, text: "Still with you" },
    { time: 10600, text: "Eoduunbang jomyeong hana eopsi" },
    { time: 15000, text: "Iksukaejimyeon an doeneunde" },
    { time: 17100, text: "Geuge tto iksukae" },
    { time: 21400, text: "Najimagi deullineun" },
    { time: 23400, text: "I eeokeon sori" },
    { time: 25400, text: "Igeorado eopseumyeon" },
    { time: 29400, text: "Na jeongmal muneojil geot gata" },
    { time: 31400, text: "Hamkke utgo hamkke ulgo" },
    { time: 35400, text: "I dansunhan gamjeongdeuri" },
    { time: 37400, text: "Naegen jeonbuyeonna bwa" },
    { time: 39400, text: "Eonjejjeumilkka" },
    { time: 43400, text: "Dasi geudael majuhandamyeon" },
    { time: 45400, text: "Nuneul bogo malhallaeyo" },
    { time: 47700, text: "Bogo sipeosseoyo" },
    { time: 56200, text: "Hwangholhaetdeon gieok soge" },
    { time: 58600, text: "Na hollo chumeul chwodo biga naerijana" },
    { time: 68400, text: "I angaega geotil ttaejjeum" },
    { time: 75000, text: "Jeojeun ballo dallyeogal ge" },
    { time: 79100, text: "Geuttae nal anajwo" },
    { time: 85900, text: "Jeo dari oerowo boyeoseo" },
    { time: 111400, text: "Bamhaneure hwanhage ulgo inneun geot gataseo" },
    { time: 117300, text: "Eonjenga achimi oneun geol almyeonseodo" },
    { time: 119700, text: "Byeolcheoreom neoui haneure meomulgo sipeosseo" },
    { time: 122400, text: "Harureul geu sunganeul" },
    { time: 126500, text: "Ireoke doel geol aratdamyeon" },
    { time: 128500, text: "Deo damadwosseul tende" },
    { time: 130600, text: "Eonjejjeumilkka" },
    { time: 136000, text: "Dasi geudael majuhandamyeon" },
    { time: 139400, text: "Nuneul bogo malhallaeyo" },
    { time: 143600, text: "Bogo sipeosseoyo" },
    { time: 150000, text: "Hwangholhaetdeon gieok soge" },
    { time: 152800, text: "Na hollo chumeul chwodo biga naerijana" },
    { time: 209700, text: "I angaega geotil ttaejjeum" },
    { time: 211800, text: "Jeojeun ballo dallyeogal ge" },
    { time: 216400, text: "Geuttae nal jabajwo" },
    { time: 219000, text: "Nal baraboneun huimihan miso dwipyeone" },
    { time: 221900, text: "Areumdaun boratbicheul geuryeobollaeyo" },
    { time: 226500, text: "Seoro balgeoreumi an majeul sudo itjiman" },
    { time: 228500, text: "Geudaewa hamkke i gireul geotgo sipeoyo" },
    { time: 232700, text: "Still with you" }
  ]
    }, 
];
