...
let songs = [
  ...
  lyrics: [
    { time: 1.0, text: "Nal seuchineun geudaeui yeoteun geu moksori" },
    { time: 9.1, text: "Nae ireumeul han beonman deo bulleojuseyo" },
    { time: 35.0, text: "Eoreobeorin noeul arae meomchwo seoitjiman" },
    { time: 35.9, text: "Geudae hyanghae han georeumssik georeogallaeyo" },
    { time: 41.7, text: "Still with you" },
    { time: 47.3, text: "Eoduunbang jomyeong hana eopsi" },
    { time: 50.0, text: "Iksukaejimyeon an doeneunde" },
    { time: 54.7, text: "Geuge tto iksukae" },
    { time: 56.7, text: "Najimagi deullineun" },
    { time: 62.4, text: "I eeokeon sori" },
    { time: 66.3, text: "Igeorado eopseumyeon" },
    { time: 67.9, text: "Na jeongmal muneojil geot gata" },
    { time: 71.8, text: "Hamkke utgo hamkke ulgo" },
    { time: 73.4, text: "I dansunhan gamjeongdeuri" },
    { time: 77.2, text: "Naegen jeonbuyeonna bwa" },
    { time: 80.0, text: "Eonjejjeumilkka" },
    { time: 83.2, text: "Dasi geudael majuhandamyeon" },
    { time: 85.4, text: "Nuneul bogo malhallaeyo" },
    { time: 88.4, text: "Bogo sipeosseoyo" },
    { time: 91.2, text: "Hwangholhaetdeon gieok soge" },
    { time: 93.7, text: "Na hollo chumeul chwodo biga naerijana" },
    { time: 96.9, text: "I angaega geotil ttaejjeum" },
    { time: 100.0, text: "Jeojeun ballo dallyeogal ge" },
    { time: 103.1, text: "Geuttae nal anajwo" },
    { time: 106.2, text: "Jeo dari oerowo boyeoseo" },
    { time: 109.7, text: "Bamhaneure hwanhage ulgo inneun geot gataseo" },
    { time: 112.4, text: "Eonjenga achimi oneun geol almyeonseodo" },
    { time: 115.8, text: "Byeolcheoreom neoui haneure meomulgo sipeosseo" },
    { time: 118.6, text: "Harureul geu sunganeul" },
    { time: 121.6, text: "Ireoke doel geol aratdamyeon" },
    { time: 124.0, text: "Deo damadwosseul tende" },
    { time: 127.0, text: "Eonjejjeumilkka" },
    { time: 130.2, text: "Dasi geudael majuhandamyeon" },
    { time: 132.6, text: "Nuneul bogo malhallaeyo" },
    { time: 135.7, text: "Bogo sipeosseoyo" },
    { time: 138.0, text: "Hwangholhaetdeon gieok soge" },
    { time: 140.8, text: "Na hollo chumeul chwodo biga naerijana" },
    { time: 197.7, text: "I angaega geotil ttaejjeum" },
    { time: 199.8, text: "Jeojeun ballo dallyeogal ge" },
    { time: 204.4, text: "Geuttae nal jabajwo" },
    { time: 207.0, text: "Nal baraboneun huimihan miso dwipyeone" },
    { time: 209.9, text: "Areumdaun boratbicheul geuryeobollaeyo" },
    { time: 214.5, text: "Seoro balgeoreumi an majeul sudo itjiman" },
    { time: 216.5, text: "Geudaewa hamkke i gireul geotgo sipeoyo" },
    { time: 220.7, text: "Still with you" }
]
  },  
];
